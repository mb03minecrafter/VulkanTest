...
void VMemTransferCommandPool::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void VMemTransferCommandPool::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkCommandBuffer VMemTransferCommandPool::beginSingleTimeCommands()
{
...
void VMemTransferCommandPool::endSingleTimeCommands(VkCommandBuffer commandBuffer)
{
